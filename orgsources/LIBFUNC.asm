...
GET_INT:	EQU	&H0100
PUT_INT:	EQU	&H0103
COLOR_WHITE	EQU	&H0106
COLOR_BLACK	EQU	&H0109
SCREEN_ON	EQU	&H010C
SCREEN_OFF	EQU	&H010F
SET_SCREEN0	EQU	&H0112
SET_SCREEN5	EQU	&H0115
SPRITES_ON	EQU	&H0118
SPRITES_OFF	EQU	&H011B
;PUT_SPRITE    EQU     &H011E
SET_PAGE	EQU	&H0121
GET_TIME	EQU	&H0124
PUT_TXT	EQU	&H0127
PUT_TXT2	EQU	&H012A
SAVE_ENTRY	EQU	&H012D
EXIT_ON_ERR	EQU	&H0130
...
PUT_NAM_FCB:	;                         ; In:  HL = file name pointer
	LD	DE,FCB+1
	LD	BC,&H0B	; Out: A  = drive name (0 = def., 1 =  
