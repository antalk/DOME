...
;----------------------------------
	...
	DW	&H000F	; DE AANTAL KEER VOORDAT DE AI ACTIE 
AI:
	RET
	JR	AI_WAIT

	CALL	AI_UPDATE_TNKS	; UPDATE THE MS OF THE TNKS   
	CALL	AI_ADD_TNKS	; ADD TNKS AND SET'S THERE MS   
	CALL	AI_MAPPING	; MAKS MS TABS / MAKS MAP TABS / ANI 
	RET		; MS = MISSION   
...
AI_WAIT:
	...
	RET
AI_INIT:
	LD	B,16	; HOEFT NU NOG NIET   
AI_INIT_LP:
	PUSH	BC	; MAAR WEL NA SAVE GAME EN BY INI  
	CALL	AI_MAPPING	; KAN OOK ALLEN AI WORDEN   
	POP	BC
	DJNZ	AI_INIT_LP	; DIT IS EVEN DE 16 SECTORS UPDATEN   
	RET
...
;----------------------------------
; AI VOOR BLAUWE UNITS ( DE SPELER )
;------------- ALLEEN VOOR DE BLAUWE HARV
;
;  IX+16 WORDT EVEN GEBRUIKT OM HET GELD INOP TE SLAAN
;
AI_HARVB:
...
AI_ADD_TNK_TYPE:	DB	0	; TIJDELIJKE OPSLAG VOOR TYPE TAN 
	;                            ; NOG NIET IN GEBUIK   
