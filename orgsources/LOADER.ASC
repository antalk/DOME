...
INIT_SCR:
	...
	LD	C,7
	LD	B,&B11110000	; COLOR 15,0,0  
	LD	IY,(&HFCC1)
	LD	IX,&H47	; DE INSTELLING V.D. MENSE  
	CALL	&H1C
...
DOSAGAIN:
	...
	;   LD      HL,COLOR_DOME_GAME   ; MOET COLOR BASIC
	;   CALL    PUT_COLOR

	;   LD      HL,RET
	;   CALL    PUT_TXT2         ; ZONDER DOME
	;   LD      HL,TXT_THANKS
	;   CALL    PUT_TXT2         ; ZONDER DOME
	RET
;-------------------------------------
